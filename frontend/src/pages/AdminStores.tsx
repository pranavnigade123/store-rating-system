...
const AdminStores = () => {
  ...
  const columns = [
    { key: 'name', label: 'Store Name', sortable: true, width: '18%' },
    { key: 'email', label: 'Email', sortable: true, width: '18%' },
    { key: 'owner_name', label: 'Owner', sortable: false, width: '15%' },
    { key: 'address', label: 'Address', sortable: true, width: '22%' },
    { key: 'average_rating', label: 'Rating', sortable: false, width: '10%' },
    { key: 'total_ratings', label: 'Reviews', sortable: false, width: '8%' },
    { key: 'created_at', label: 'Created', sortable: true, width: '9%' }
  ];
    ...
    <div className="min-h-screen bg-slate-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 mb-2">Manage Stores</h1>
            <p className="text-slate-600">Create and manage store listings</p>
          </div>
          <button
            onClick={() => {
              setShowModal(true);
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl p-8 w-full max-w-lg max-h-[90vh] overflow-y-auto">
              <h2 className="text-2xl font-bold mb-6 text-slate-900">Create New Store</h2>
              ...
              <form onSubmit={handleCreateStore} className="space-y-5">
                ...
                <div>
                  ...
                  {formErrors.ownerUserId && (
                    <p className="text-red-600 text-sm mt-1">{formErrors.ownerUserId}</p>
                  )}
                </div>
